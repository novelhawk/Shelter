...
namespace Mod.Discord.Registry
{
	/// <summary>
	/// From https://github.com/Lachee/discord-rpc-csharp/blob/master/Discord%20RPC/Registry/UriScheme.cs
	/// </summary>
    public static class UriScheme
    {
		...
		public static void RegisterUriScheme(string appid, string steamid = null, string arguments = null)
		{
			...
			string command = $"{location} {arguments}";
			...
			if (!string.IsNullOrEmpty(steamid))
			{
				...
				if (steam != null)
					command = $"\"{steam}\" steam://rungameid/{steamid}";
